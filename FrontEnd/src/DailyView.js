...
function DailyView() {
    ...
    useEffect(() => {
        axios.post('http://localhost:7000/Check-Daily-Score', {}, {
            headers: {
    ...
    useEffect(() => {
        axios.get('http://localhost:7000/taskInfo', {
            headers: {
                authorization: `Bearer ${token}`,
    ...
    useEffect(() => {
        let sum = data.slice(-7).reduce((prev, cur) => {
            return prev + cur.Avg;
        }, 0);
                    ...
                    <div className='mc-close-width d-flex'>
                        <div className="collapse navbar-collapse mc-nav-center" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto ms-0 ms-md-5  mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-Link mc-normalbtn text-primary" to="#" style={{ width: "200px" }}>Weekly Progress</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <main className='weely-view-main'>
                <div className='header-title'>
                    <div className='d-flex'>
                        ...
                        <div>
                            ...
                            <div style={{ color: "grey" }}>Monitor your daily and weekly achievements</div>
                        </div>
                    </div>
                </div>
                ...
                <div className='weekly-icon-container '>
                    ...
                    <div>
                        ...
                        <div className='ms-3 text-grey'>
                            Track your consistent over the last 7 days
                        </div>
                    </div>
                </div>
                ...
                <div className='last-panel'>
                    <div className='insight-heading'>
                        ...
                        <div>
                            <div className='fs-2 fw-bold'>Daily Insight</div>
                        </div>
                    </div>
                    <div className='mt-4'>
                        Great work yesterday with 85% task completion! you are on task with an 81%
                        weekly average. Stay focused and you'll even higher achievements! &#128170;
                    </div>
                </div>
